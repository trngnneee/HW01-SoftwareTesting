...
![QA/QC Role Mind Map](./images/QAQC_mindmap.png)

**3 issues with the mind map based on the assignment:**

1. **No mention of AI/ML impact** – All 10 job postings include an AI Impact Analysis section, yet the mind map has no branch covering AI tools, AI evaluation, LLM testing, test automation, or AI-assisted QA workflows.
2. **Rigid QA (Proactive) / QC (Reactive) split does not reflect modern practice** – For example, "Testing & Inspection" is placed only under QC, but shift-left testing and AI-assisted test generation are proactive activities. "Metrics & KPIs" and "Documentation & Reporting" appear in both QA and QC roles in the job listings, but the mind map assigns them solely to QC.
3. **Core Skills branch lacks specific technical competencies** – The jobs require automation frameworks (Selenium, Playwright), API testing (Postman), SQL, CI/CD, and AI evaluation frameworks (DeepEval, Ragas, LangSmith), but the mind map only lists a generic "Technical & Tools" item.
...
- **Source link**: https://www.lookout.com/threat-intelligence/article/blastpass-ios-16-6-and-15-7-8
...
- **Source link**: https://apnews.com/article/apple-ai-news-hallucinations-iphone-6b37a11b9cdd0e100c299e922d58b530
...
- **Source link**: https://www.envive.ai/post/case-study-of-air-canadas-chatbot
...
- **Source link**: https://lawreview.syr.edu/openai-defamation-lawsuit-the-first-of-its-kind/
...
- This section includes videos demonstrating the execution of the test cases, particularly focusing on the 3 edge cases that AI tools failed to identify. These videos provide visual evidence of the issues encountered during testing and highlight the importance of thorough testing beyond what AI can predict.
...
#### 4.1. Video of Test Case 1: Verify all keys register correctly

- __Video link__: [Test Case 1 Video](https://drive.google.com/file/d/1rXYh-jzUu7hUD4ubHPojDUu40VE9TgOr/view?usp=drive_link)

#### 4.2. Video of Test Case 2: Verify N-key rollover

- __Video link__: [Test Case 2 Video](https://drive.google.com/file/d/1mrA7-9BlfkU83782yj11NuKlQlFNwPpA/view?usp=drive_link)

#### 4.3. Video of Test Case 3: Verify rapid switching between all connection modes

- __Video link__: [Test Case 3 Video](https://drive.google.com/file/d/19nlmILaFmOF6yfh5Qc_9OL3UVLIO9hjU/view?usp=drive_link)

#### 4.4. Video of Test Case 4: Verify noise of keyboard

- __Video link__: [Test Case 4 Video](https://drive.google.com/file/d/1gU5MNse6NPKjvC2u-Tg4kHGy3t8-Ngb3/view?usp=drive_link)

#### 4.5. Video of Test Case 5: Verify keyboard support PrtScr button to take screenshot

- __Video link__: [Test Case 5 Video](https://drive.google.com/file/d/18BXIWi9ApmLcpqkcLmLWIvnKaOTbqVZ_/view?usp=drive_link)
